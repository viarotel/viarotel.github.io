import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.828db4c4.js";const m=JSON.parse('{"title":"避免 vue 双向绑定进入死循环","description":"","frontmatter":{},"headers":[],"relativePath":"memo/web/vmodel-loop-error.md","filePath":"memo/web/vmodel-loop-error.md","lastUpdated":1697608594000}'),p={name:"memo/web/vmodel-loop-error.md"},o=l(`<h1 id="避免-vue-双向绑定进入死循环" tabindex="-1">避免 vue 双向绑定进入死循环 <a class="header-anchor" href="#避免-vue-双向绑定进入死循环" aria-label="Permalink to &quot;避免 vue 双向绑定进入死循环&quot;">​</a></h1><blockquote><p>更新绑定值时校验值是否相等 如果相等则不进行更新</p></blockquote><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { isEqual } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;lodash-es&#39;</span></span>
