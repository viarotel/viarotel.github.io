import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.04934dae.js";const u=JSON.parse('{"title":"vue 中子组件调用父组件方法最佳实践","description":"","frontmatter":{},"headers":[],"relativePath":"memo/web/vue-call-parent-method.md","filePath":"memo/web/vue-call-parent-method.md","lastUpdated":1695107779000}'),p={name:"memo/web/vue-call-parent-method.md"},t=l(`<h1 id="vue-中子组件调用父组件方法最佳实践" tabindex="-1">vue 中子组件调用父组件方法最佳实践 <a class="header-anchor" href="#vue-中子组件调用父组件方法最佳实践" aria-label="Permalink to &quot;vue 中子组件调用父组件方法最佳实践&quot;">​</a></h1><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// parent-component</span></span>
